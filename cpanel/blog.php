            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <a href="./vietbai.php" class="btn btn-info">Viết bài</a>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php danhsach_baiviet() ?>
                                        <?php if (isset($_GET['idbaivietxoa'])) {
                                            $idbaivietxoa = $_GET['idbaivietxoa'];
                                           xoabaiviet($idbaivietxoa);
                                       }
                                       ?>
                                    </tbody>
                                </table>
