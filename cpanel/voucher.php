                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="row" style="text-align: center;">
                                <form class="card-body col-md-6 col-sm-12 col-xs-12" method="POST">
                                    <input type="number" name="timkiem_value" class="btn" style="border: 1px solid var(--green); color:#333; background:none;" placeholder="Nhập mã voucher cần tìm" required>
                                    <button type="submit" name="btnTimkiem" class="btn btn-info">Tìm kiếm</button>
                                </form>
                                <form class="card-body col-md-6 col-sm-12 col-xs-12" method="POST">
                                    <input type="number" name="giatri" class="btn" style="border: 1px solid var(--green); color:#333; background:none;" placeholder="Giá trị voucher" required>
                                    <button href="voucher.php" type="submit" name="btnthemvc" class="btn btn-info">Thêm Voucher</button>
                                </form>
                            </div>
                        </div>
                        <div class="card">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_POST['btnTimkiem'])) {
                                            $ma_vc= $_POST['timkiem_value'];
                                            timkiem_vc($ma_vc);
                                        }else{danhsach_voucher();}  ?>
                                        <?php if (isset($_GET['idvc'])) {
                                           xoa_voucher();
                                       }
                                        if (isset($_GET['idvc_sua'])) {
                                            sua_vc();
                                        } 
                                        if (isset($_POST['btnthemvc'])) {
                                            $giatri = $_POST['giatri'];
                                            them_vc($giatri);
                                        }  ?>
                                    </tbody>
